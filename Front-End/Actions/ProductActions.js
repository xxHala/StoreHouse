...
export const ProductActions = () => {
  ...
  useEffect(() => {
    fetch("http://127.0.0.1:8080/storeHouse/Products/all-product.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const insertProduct = (newProduct) => {
    fetch(" http://127.0.0.1:8080/storeHouse/Products/add-product.php", {
      method: "POST",
      headers: {
  ...
  const updateProductData = (prod_data) => {
    fetch("http://127.0.0.1:8080/storeHouse/Products/update-product.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteProductData = (theID) => {
    ...
    fetch("http://127.0.0.1:8080/storeHouse/delete-product.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
